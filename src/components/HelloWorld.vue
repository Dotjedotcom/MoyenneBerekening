...
<!--                <p class="navbar-brand">MoyenneBerekening</p>-->
<!--            </div>-->
<!--        </nav>-->
<!--        <div class="container-fluid">-->
<!--            <div class="row">-->
...
<!--                                    <input type="number" class="form-control" ng-model="selectedPlayer" id="bondsnummer"-->
<!--                                           placeholder="123456">-->
<!--                                </div>-->
<!--                                <button type="submit" class="btn btn-primary" ng-click="fetchPlayer()">Go!</button>-->
<!--                            </form>-->
<!--                            <hr/>-->
<!--                            <span ng-repeat="(id, data) in players"><button type="button" class="btn btn-default"-->
<!--                                                                            ng-click="setPlayer(data)"-->
<!--                                                                            ng-class="{'btn-primary': id == fetchedPlayer}">{{ data.name }}</button> </span>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
